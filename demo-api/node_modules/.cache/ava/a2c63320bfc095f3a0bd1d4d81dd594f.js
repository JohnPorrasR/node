...
test.serial.cb('/api/agents', t => {
    request(server).get('/api/agents').expect(200).expect('Content-Type', /json/).end((err, res) => {
        ...
        t.falsy(_rec._expr(_rec._capt(err, 'arguments/0'), {
            content: 't.falsy(err, \'should not return an error\')',
            filepath: 'tests/api-test.js',
            line: 14,
            ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"falsy","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"Identifier","name":"err","range":[8,11]},{"type":"StringLiteral","value":"should not return an error","range":[13,41]}],"range":[0,42]}',
            tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"falsy","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"err","range":[8,11]},{"type":{"label":","},"range":[11,12]},{"type":{"label":"string"},"value":"should not return an error","range":[13,41]},{"type":{"label":")"},"range":[41,42]}]',
...
//# sourceMappingURL=../node_modules/.cache/ava/a2c63320bfc095f3a0bd1d4d81dd594f.js.map